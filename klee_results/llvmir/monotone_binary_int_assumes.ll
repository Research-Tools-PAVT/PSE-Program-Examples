; ModuleID = 'src/monotone_binary_int_assumes.cpp'
source_filename = "src/monotone_binary_int_assumes.cpp"
...
106:                                              ; preds = %60
  call void @mark_state_winning(), !dbg !1569
  %107 = load i8, i8* %16, align 1, !dbg !1570
  %108 = trunc i8 %107 to i1, !dbg !1570
  br i1 %108, label %110, label %109, !dbg !1572

109:                                              ; preds = %106
  call void @klee_dump_kquery_state(), !dbg !1573
...
!12 = !DIFile(filename: "src/monotone_binary_int_assumes.cpp", directory: "/home/clustfuzz/Documents/Research/PSE-Program-Examples")
!13 = !{!14}
...
!1482 = !DILocation(line: 69, column: 1, scope: !1461)
...
!1569 = !DILocation(line: 62, column: 3, scope: !1448)
!1570 = !DILocation(line: 64, column: 8, scope: !1571)
!1571 = distinct !DILexicalBlock(scope: !1448, file: !12, line: 64, column: 7)
!1572 = !DILocation(line: 64, column: 7, scope: !1448)
!1573 = !DILocation(line: 65, column: 5, scope: !1574)
!1574 = distinct !DILexicalBlock(scope: !1571, file: !12, line: 64, column: 16)
!1575 = !DILocation(line: 66, column: 3, scope: !1574)
!1576 = !DILocation(line: 68, column: 3, scope: !1448)
