...
module pivot
	...
	[flip1] s=0 -> 0.5 : (s'=1);
	[flipP] s=0 -> 0.5 : (s'=2);
	[flip2] s=1 -> 0.5 : (s'=3) + 0.5 : (s'=4);
	[flip3] s=2 -> 0.5 : (s'=5) + 0.5 : (s'=6);
    [flip4] s=3 -> 0.5 : (s'=7) + 0.5 : (s'=8);
    ...
    [flip5] s=4 -> 0.5 : (s'=11) & (pivot'=5) & (maxval'=5) + 0.5 : (maxval'=5) & (pivot'=6) & (s'=11);
    [flip8] s=5 -> 0.5 : (s'=11) & (pivot'=7) & (maxval'=6) + 0.5 : (maxval'=7) & (pivot'=8) & (s'=11);
