...
OPTIMIZE_ARR = [
    1 * y_sym - prob_sym * n_sym * y_sym,
    2 * y_sym - prob_sym * n_sym * y_sym,
    3 * y_sym - prob_sym * n_sym * y_sym,
    3 * y_sym - prob_sym * n_sym * y_sym,
    3 * y_sym - prob_sym * n_sym * y_sym,
    3 * y_sym - prob_sym * n_sym * y_sym,
    4 * y_sym - prob_sym * n_sym * y_sym,
    4 * y_sym - prob_sym * n_sym * y_sym,
    5 * y_sym - prob_sym * n_sym * y_sym,
    6 * y_sym - prob_sym * n_sym * y_sym,
]
