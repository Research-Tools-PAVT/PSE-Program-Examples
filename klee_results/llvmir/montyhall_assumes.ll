; ModuleID = 'src/montyhall_assumes.cpp'
source_filename = "src/montyhall_assumes.cpp"
...
define i32 @main() #4 !dbg !1519 {
  ...
  %17 = load i32, i32* %2, align 4, !dbg !1540
  %18 = icmp eq i32 %17, 1, !dbg !1541
  br i1 %18, label %19, label %22, !dbg !1542

19:                                               ; preds = %0
  %20 = load i32, i32* %4, align 4, !dbg !1543
  %21 = icmp eq i32 %20, 0, !dbg !1544
  br i1 %21, label %39, label %22, !dbg !1545

22:                                               ; preds = %19, %0
  %23 = load i32, i32* %2, align 4, !dbg !1546
  %24 = icmp eq i32 %23, 1, !dbg !1547
  br i1 %24, label %25, label %28, !dbg !1548

25:                                               ; preds = %22
  %26 = load i32, i32* %4, align 4, !dbg !1549
  %27 = icmp eq i32 %26, 1, !dbg !1550
  br i1 %27, label %39, label %28, !dbg !1551

28:                                               ; preds = %25, %22
  %29 = load i32, i32* %2, align 4, !dbg !1552
  %30 = icmp eq i32 %29, 0, !dbg !1553
  br i1 %30, label %31, label %37, !dbg !1554

31:                                               ; preds = %28
  %32 = load i32, i32* %3, align 4, !dbg !1555
  %33 = icmp ne i32 %32, 1, !dbg !1556
  br i1 %33, label %34, label %37, !dbg !1557

34:                                               ; preds = %31
  %35 = load i32, i32* %4, align 4, !dbg !1558
  %36 = icmp eq i32 %35, 1, !dbg !1559
  br label %37

37:                                               ; preds = %34, %31, %28
  %38 = phi i1 [ false, %31 ], [ false, %28 ], [ %36, %34 ], !dbg !1560
  br label %39, !dbg !1551

39:                                               ; preds = %37, %25, %19
  %40 = phi i1 [ true, %25 ], [ true, %19 ], [ %38, %37 ]
  %41 = zext i1 %40 to i64, !dbg !1561
  call void @klee_assume(i64 %41), !dbg !1562
...
!12 = !DIFile(filename: "src/montyhall_assumes.cpp", directory: "/home/clustfuzz/Documents/Research/PSE-Program-Examples")
!13 = !{!14}
...
!1541 = !DILocation(line: 82, column: 28, scope: !1519)
!1542 = !DILocation(line: 82, column: 33, scope: !1519)
!1543 = !DILocation(line: 82, column: 36, scope: !1519)
!1544 = !DILocation(line: 82, column: 40, scope: !1519)
!1545 = !DILocation(line: 82, column: 46, scope: !1519)
!1546 = !DILocation(line: 83, column: 16, scope: !1519)
!1547 = !DILocation(line: 83, column: 28, scope: !1519)
!1548 = !DILocation(line: 83, column: 33, scope: !1519)
!1549 = !DILocation(line: 83, column: 36, scope: !1519)
!1550 = !DILocation(line: 83, column: 40, scope: !1519)
!1551 = !DILocation(line: 83, column: 46, scope: !1519)
!1552 = !DILocation(line: 84, column: 16, scope: !1519)
!1553 = !DILocation(line: 84, column: 28, scope: !1519)
!1554 = !DILocation(line: 84, column: 33, scope: !1519)
!1555 = !DILocation(line: 84, column: 36, scope: !1519)
!1556 = !DILocation(line: 84, column: 43, scope: !1519)
!1557 = !DILocation(line: 84, column: 48, scope: !1519)
!1558 = !DILocation(line: 84, column: 51, scope: !1519)
!1559 = !DILocation(line: 84, column: 55, scope: !1519)
!1560 = !DILocation(line: 0, scope: !1519)
!1561 = !DILocation(line: 82, column: 15, scope: !1519)
!1562 = !DILocation(line: 82, column: 3, scope: !1519)
