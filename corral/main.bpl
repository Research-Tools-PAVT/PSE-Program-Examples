...
// via /usr/local/bin/smack --no-verify main.c -bpl main.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 19608));
...
$bb0:
  call $initialize();
  assume {:sourceloc "main.c", 7, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "main.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "main.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "main.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i0, $i1);
  assume {:sourceloc "main.c", 7, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "main.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 1);
  call {:cexpr "a"} boogie_si_record_i32($i3);
  assume {:sourceloc "main.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($i1, 1);
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "main.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "main.c", 12, 3} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "main.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 2064));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 3096));
...
axiom (__SMACK_dummy == $sub.ref(0, 4128));
...
axiom (__SMACK_and32 == $sub.ref(0, 6192));
...
axiom (__SMACK_and64 == $sub.ref(0, 7224));
...
axiom (__SMACK_and16 == $sub.ref(0, 8256));
...
axiom (__SMACK_and8 == $sub.ref(0, 9288));
...
axiom (__SMACK_or32 == $sub.ref(0, 10320));
...
axiom (__SMACK_or64 == $sub.ref(0, 11352));
...
axiom (__SMACK_or16 == $sub.ref(0, 12384));
...
axiom (__SMACK_or8 == $sub.ref(0, 13416));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 14448));
...
axiom (__SMACK_decls == $sub.ref(0, 15480));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 16512));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 17544));
